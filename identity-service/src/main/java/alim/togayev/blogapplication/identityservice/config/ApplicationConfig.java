package alim.togayev.blogapplication.identityservice.config;
...
public class ApplicationConfig {
    private final UserCredentialRepo userCredRepository;

    public ApplicationConfig(UserCredentialRepo userCredRepository) {
